...
const CoachsCreate = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if (!resp.ok) {
            setError(data.error || "Error creating coach");
            return;
        }
    ...
    return (
        <div className="d-flex justify-content-center align-items-center" style={{ minHeight: "80vh", marginTop: "40px" }}>
            ...
            >
                <h2 className="mb-4 text-center" style={{ fontWeight: "700" }}>Create Coach</h2>

                {error && <div className="alert alert-danger py-2" style={{ fontSize: "0.9rem" }}>{error}</div>}

                <form onSubmit={handleCreate}>
                    <div className="text-start mb-3">
                        <label className="form-label small fw-bold text-muted">Coach Email</label>
                        <input
                            type="email"
                    ...
                    <div className="d-grid gap-2">
                        ...
                        <Link to="/coachs" className="btn btn-link text-muted text-decoration-none">
                            Back to List
                        </Link>
                    </div>
                </form>
