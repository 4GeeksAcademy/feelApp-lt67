    ...
    >
      ...
      <style>{`
        @keyframes liquidFlow {
          ...
          25% { transform: translate(-48%, -48%) scale(1.05); opacity: 0.9; }
          50% { transform: translate(-50%, -50%) scale(1.02); opacity: 0.85; }
          75% { transform: translate(-52%, -52%) scale(0.98); opacity: 0.9; }
          100% { transform: translate(-50%, -50%) scale(1); opacity: 0.8; }
        }

        @keyframes shimmer {
          0% { box-shadow: 0 0 20px rgba(255, 255, 255, 0.1), inset 0 0 15px rgba(255, 255, 255, 0.2), 0 0 40px rgba(179, 229, 252, 0.2); }
          50% { box-shadow: 0 0 30px rgba(255, 255, 255, 0.15), inset 0 0 20px rgba(255, 255, 255, 0.3), 0 0 60px rgba(179, 229, 252, 0.3); }
          100% { box-shadow: 0 0 20px rgba(255, 255, 255, 0.1), inset 0 0 15px rgba(255, 255, 255, 0.2), 0 0 40px rgba(179, 229, 252, 0.2); }
        }
