...
const admintCRUD = () => {
    ...
    const handleCreate = async (e) => {
        ...
        dispatch({ type: "set_admints", payload: [...store.admints, data] });
        setEmail("");
        setPassword("");
    };

    const handleEdit = (admint) => {
    ...
    const handleUpdate = async (id) => {
        ...
        dispatch({
            type: "set_admints",
            payload: store.admints.map(a => a.id === id ? data : a)
        });
        setEditingId(null);
    };
                    ...
                    {store.admints.length === 0 ? (
                        ...
                        store.admints.map(admint => (
                            <tr key={admint.id}>
                                ...
                                <td>{new Date(admint.sign_up_date).toLocaleDateString()}</td>
                                <td>
                                    {editingId === admint.id ? (
                                        <div className="d-flex gap-2">
                                            ...
                                            <button
                                                ...
                                                onClick={() => handleUpdate(admint.id)}
                                            >
                                                Save
                                            </button>
                                            <button
